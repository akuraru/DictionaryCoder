...
open class DictionaryDecoder {
    ...
    ///
    /// - parameter type: The type of the value to decode.
    /// - parameter container: The top-level Dict container.
...
// NOTE: older overlays called this class _DictDecoder. The two must
...
fileprivate struct _DictDecodingStorage {
    ...
    /// The container stack.
    /// Elements may be any one of the Dict types (NSNumber, Date, String, Array, [String : Any]).
...
extension __DictDecoder {
    ...
    fileprivate func unbox(_ value: Any, as type: Bool.Type) throws -> Bool? {
        if let string = value as? String, string == _DictNull { return nil }
    ...
    fileprivate func unbox(_ value: Any, as type: String.Type) throws -> String? {
        ...
        return string == _DictNull ? nil : string
    }
...
//===----------------------------------------------------------------------===//
// Shared Dict Null Representation
//===----------------------------------------------------------------------===//

// Since Dicts do not support null values by default, we will encode them as "$null".
...
fileprivate struct _DictKey : CodingKey {
    ...
    fileprivate static let `super` = _DictKey(stringValue: "super")!
}

extension DecodingError {
    static func _typeMismatch(at codingPath: [CodingKey], expectation: Any.Type, reality topContainer: Any) -> DecodingError {
        return DecodingError.typeMismatch(expectation, DecodingError.Context.init(codingPath: codingPath, debugDescription: ""))
    }
}
