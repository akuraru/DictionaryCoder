#
# Be sure to run `pod lib lint DictionaryCoder.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'DictionaryCoder/Classes/**/*'
  
  # s.resource_bundles = {
  #   'DictionaryCoder' => ['DictionaryCoder/Assets/*.png']
  # }
